...
export default function Home(){
 ...
 return <main>
  <header className="hero"><nav className="nav-shell"><div className="brand"><span className="brand-mark">B</span><span>Buonissimo!</span></div><div className="nav-note">Ricette semplici per piccoli buongustai</div></nav><section className="hero-content"><p className="eyebrow">100 idee · da 1 a 3 anni</p><h1>Oggi cosa<br/><em>prepariamo?</em></h1><p className="hero-copy">Trova una ricetta partendo da quello che hai in frigo, oppure lascia decidere alla magia.</p><button className="magic-button" onClick={randomRecipe}><span>✦</span> Scegli per me</button></section><div className="hero-orb hero-orb-one"/><div className="hero-orb hero-orb-two"/></header>
