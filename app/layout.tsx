...
export const metadata:Metadata={title:"Ricette 1–3 anni",description:"Cerca e filtra 100 ricette semplici per bambini da 1 a 3 anni.",icons:{icon:{url:"/favicon.svg?v=2",type:"image/svg+xml"}},other:{"codex-preview":"development"}};
